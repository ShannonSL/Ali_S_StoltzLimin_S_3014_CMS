...
function addProduct($pic, $name, $text, $price, $cat) {
    try {
        ...
        $insert_prod_query = 'INSERT INTO tbl_products(prod_img, prod_name, prod_desc, prod_price)';
        ...
        $insert_cat_query = 'INSERT INTO tbl_product_category (prod_id, cat_id) VALUES ("'. $last_id.'", :cat_id)';
...
function editProduct($pic, $name, $desc, $price, $category) {
      ...
      try {
        ...
        if($pic){
            ...
            $query = "UPDATE tbl_products SET prod_name = :product_name, prod_img = :product_image, prod_desc = :product_text, prod_price = :product_price; WHERE prod_id = :product_id";
            ...
            $query = "UPDATE tbl_products SET prod_name = :product_name, prod_price = :product_price, prod_desc = :product_text WHERE prod_id = :product_id";
    ...
    if($category){
        ...
        $change_cat_query = "UPDATE tbl_product_category SET cat_id = :cat_id WHERE prod_id = :product_id";
