...
<input type="text" name="name"  value="<?php echo $row['prod_name'];?>" id="prod-name" class="form-control">


<input type="text" id="prod-desc" name="desc" class="form-control" value="<?php echo $row['prod_desc'];?>">


<input type="text" name="price" id="prod-price" class="form-control" value="<?php echo $row['prod_price'];?>">
...
<div class="file-field">
    <div class="btn btn-primary float-center ">
		...
		<input type="file" name="pic" id="pic" value="<?php echo $row['prod_img'];?>"><br>
